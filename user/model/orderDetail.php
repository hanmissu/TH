...
class orderModel{
    ...
    public function __construct($maDonHang, $ngayXuatDon,$tenKH,$trangThai,$diaChi,$tongTien)
    {
        $this->maDonHang = $maDonHang;
        $this->ngayXuatDon = $ngayXuatDon;
        $this->tenKH = $tenKH;
    ...
    public function  inssertorder()
    {
        ...
        $pdo = $dbConnet->connet();
        $sql = "INSERT INTO donhang (maDonHang,ngayXuat,tenKH,trangThai,diaChi,tongTien)
         VALUES (:maDonHang,:ngayXuatDon,:tenKH,:trangThai,:diaChi,:tongTien)";
    ...
    public function updateData()
    {
        ...
        $dbConnet = new MySQLConnet();
        $sql = "UPDATE donhang set maDonHang=:maDonHang,ngayXuat=:ngayXuat,tenKH=:tenKH,trangThai=:trangThai,diaChi=:diaChi,tongTien=:tongTien
